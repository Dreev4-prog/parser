...
and optional +3/+6/+12h measurements, but they no longer create or re-arm shared
Radar observations and therefore cannot flood the checkpoint queue.

AutoScan admission and depth, Radar Score/HOT thresholds, the database schema and
stored observations are unchanged. See `RELEASE_4_23_16.md`, `docs/ARCHITECTURE.md` and
`docs/DEPLOYMENT.md`.
