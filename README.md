...
## v2.8.1 — фильтр рекламных/продвигаемых объявлений

По умолчанию карточки с явными признаками платного продвижения Kleinanzeigen исключаются до сбора просмотров и записи в БД. Фильтр распознаёт Top-Anzeige, Highlight, Sponsored/Promoted/Werbeanzeige и известные классы вроде `is-topad`, `badge-topad`, `is-highlight`.
