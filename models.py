...
class RadarObservation(Base):
    ...
    previous_vph: Mapped[float] = mapped_column(Float, default=0.0)
    peak_vph: Mapped[float] = mapped_column(Float, default=0.0, index=True)
    velocity_percentile: Mapped[float] = mapped_column(Float, default=0.0, index=True)
    acceleration_ratio: Mapped[float] = mapped_column(Float, default=0.0)
    confidence: Mapped[int] = mapped_column(Integer, default=0, index=True)
    scored_checkpoints: Mapped[int] = mapped_column(Integer, default=0, index=True)
    consecutive_scored: Mapped[int] = mapped_column(Integer, default=0, index=True)
